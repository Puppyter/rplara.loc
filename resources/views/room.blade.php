...
<div class="row">
    ...
    <div class="col-md-4">
        <span class="border border-dark">
            <a href="{{route('rooms.edit',['room' => $slug])}}" class="btn btn-md text-white rounded-pill" style="margin: 1em;background-color: #61892f">Edit room</a>
                <form action="{{route('invite',['room'=>$slug])}}" method="post">
                    @csrf
